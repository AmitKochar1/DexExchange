...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
    ...
    describe('withdrawing Ether', () => {
        ...
        describe('failure', () => {
            it('rejects withdrawsfor insufficient balances', async () => {
    ...
    describe('depositing tokens', () => {
        ...
        describe('failure', async () => {
            ...
            it('fails when no tokens are approved', async () => {
                //Dont approve any tokens before approving
    ...
    describe('withdrawing tokens', () => {
        ...
        describe('failure', async () => {
            ...
            it('fails for insufficient balances', async () => {
                //trying to withdraw token without depositing any first
    ...
    describe('Making orders', async () => {
        ...
        it('tracks the newly created order', async () => {
            ...
            order.tokenGet.should.equal(token.address, 'tokeGet is corrrect')
            order.amountGet.toString().should.equal(tokens(1).toString(), 'amountGet is correct')
            order.tokenGive.should.equal(ETHER_ADDRESS, 'tokeGet is correct')
        ...
        it('emits a "Order" event', async () => {
            ...
            event.tokenGet.should.equal(token.address, 'tokeGet is corrrect')
            event.amountGet.toString().should.equal(tokens(1).toString(), 'amountGet is correct')
            event.tokenGive.should.equal(ETHER_ADDRESS, 'tokeGet is correct')
